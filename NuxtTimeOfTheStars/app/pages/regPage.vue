    ...
    <div v-if="isSubmitted" class="py-20 px-4">
      <div class="max-w-2xl mx-auto text-center">
        <div class="bg-gray-800 rounded-2xl p-12 border border-gray-700">
          ...
          <h1 class="text-3xl font-bold mb-4 text-gradient">Заявка успешно отправлена!</h1>
          <p class="text-gray-300 mb-8">
            Спасибо за регистрацию команды "{{ formData.teamName }}". Мы свяжемся с вами в течение
            24 часов для подтверждения участия.
          </p>
      ...
      <section class="relative overflow-hidden">
        ...
        <div class="gradient-bg py-16 px-4 relative">
          <div class="max-w-4xl mx-auto text-center">
            <div class="text-6xl mb-6">🏒</div>
            <h1 class="text-4xl md:text-5xl font-bold mb-4 text-white">Регистрация команды</h1>
            <p class="text-xl text-white/90 max-w-2xl mx-auto">
              Присоединяйтесь к TIME OF THE STARS и станьте частью лучшей любительской хоккейной
              лиги!
            </p>
          </div>
        </div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-8">
            ...
            <div class="bg-gray-800 rounded-xl p-8 border border-gray-700">
              ...
              <div class="grid md:grid-cols-2 gap-6">
                <div>
                  <label class="block text-sm font-medium mb-2"> Название команды * </label>
                  <input
                    type="text"
                    ...
                    :class="[
                      ...
                      { 'border-red-500': errors.teamName },
                    ]"
                    placeholder="ХК Название"
                  />
                  <p v-if="errors.teamName" class="text-red-400 text-sm mt-1">
                    {{ errors.teamName }}
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p v-if="errors.city" class="text-red-400 text-sm mt-1">
                    {{ errors.city }}
                  </p>
                </div>

                <div>
                  <label class="block text-sm font-medium mb-2"> Количество игроков * </label>
                  <select
                    v-model="formData.playersCount"
                    @change="clearError('playersCount')"
                    :class="[
                      'w-full px-4 py-3 bg-gray-700 border rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-transparent transition-colors',
                      { 'border-red-500': errors.playersCount },
                    ]"
                  >
                    <option value="">Выберите количество</option>
                    <option value="15-18">15-18 игроков</option>
                    <option value="19-22">19-22 игрока</option>
                    <option value="23-25">23-25 игроков</option>
                    <option value="25+">Более 25 игроков</option>
                  </select>
                  <p v-if="errors.playersCount" class="text-red-400 text-sm mt-1">
                    {{ errors.playersCount }}
                  </p>
                </div>

                <div>
                  <label class="block text-sm font-medium mb-2"> Уровень опыта * </label>
                  <select
                  ...
                  <p v-if="errors.experience" class="text-red-400 text-sm mt-1">
                    {{ errors.experience }}
                  </p>
                </div>
              </div>
            ...
            <div class="bg-gray-800 rounded-xl p-8 border border-gray-700">
              ...
              <div class="grid md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                  <label class="block text-sm font-medium mb-2"> ФИО капитана * </label>
                  <input
                    type="text"
                    ...
                    :class="[
                      'w-full px-4 py-3 bg-gray-700 border rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-transparent transition-colors',
                      { 'border-red-500': errors.captainName },
                    ]"
                    placeholder="Иванов Иван Иванович"
                  />
                  <p v-if="errors.captainName" class="text-red-400 text-sm mt-1">
                    {{ errors.captainName }}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    :class="[
                      'w-full px-4 py-3 bg-gray-700 border rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-transparent transition-colors',
                      { 'border-red-500': errors.captainPhone },
                    ]"
                    placeholder="+7 (999) 123-45-67"
                  />
                  <p v-if="errors.captainPhone" class="text-red-400 text-sm mt-1">
                    {{ errors.captainPhone }}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    :class="[
                      'w-full px-4 py-3 bg-gray-700 border rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-transparent transition-colors',
                      { 'border-red-500': errors.captainEmail },
                    ]"
                    placeholder="captain@team.ru"
                  />
                  <p v-if="errors.captainEmail" class="text-red-400 text-sm mt-1">
                    {{ errors.captainEmail }}
                  </p>
                </div>
              </div>
            ...
            <div class="bg-gray-800 rounded-xl p-8 border border-gray-700">
              ...
              <p v-if="errors.tournaments" class="text-red-400 text-sm mt-2">
            ...
            <div class="bg-gray-800 rounded-xl p-8 border border-gray-700">
              <label class="flex items-start gap-3 cursor-pointer">
                ...
                <div class="text-sm">
                  ...
                  <a href="#" class="text-primary-blue hover:text-accent-blue transition-colors">
              ...
              <p v-if="errors.agreement" class="text-red-400 text-sm mt-2">
          ...
          <div class="grid md:grid-cols-2 gap-8">
            <div class="space-y-6">
              <div class="bg-gray-700 rounded-xl p-6">
                <h3 class="font-semibold mb-2">Какие требования к команде?</h3>
                <p class="text-gray-300 text-sm">
                  Минимум 15 игроков, возраст от 18 лет, базовые навыки игры в хоккей.
                </p>
              </div>

              <div class="bg-gray-700 rounded-xl p-6">
                <h3 class="font-semibold mb-2">Сколько стоит участие?</h3>
                <p class="text-gray-300 text-sm">
                  Регистрационный взнос составляет 15,000₽ за сезон. Включает участие во всех
                  выбранных турнирах.
                </p>
              </div>

              <div class="bg-gray-700 rounded-xl p-6">
                <h3 class="font-semibold mb-2">Когда начинается сезон?</h3>
                <p class="text-gray-300 text-sm">
                  Новый сезон стартует в сентябре. Регистрация открыта круглый год.
                </p>
              </div>
            </div>
            ...
            <div class="space-y-6">
              <div class="bg-gray-700 rounded-xl p-6">
                <h3 class="font-semibold mb-2">Нужна ли своя экипировка?</h3>
                <p class="text-gray-300 text-sm">
                  Да, каждый игрок должен иметь полную хоккейную экипировку согласно требованиям
                  безопасности.
                </p>
              </div>

              <div class="bg-gray-700 rounded-xl p-6">
                <h3 class="font-semibold mb-2">Как проходят матчи?</h3>
                <p class="text-gray-300 text-sm">
                  Матчи проводятся по выходным на ледовых аренах Ярославля. Длительность игры - 3
                  периода по 20 минут.
                </p>
              </div>

              <div class="bg-gray-700 rounded-xl p-6">
                <h3 class="font-semibold mb-2">Есть ли ограничения по возрасту?</h3>
                <p class="text-gray-300 text-sm">
                  Лига для взрослых игроков от 18 лет. Верхних ограничений нет.
                </p>
              </div>
            </div>
          </div>
...
const validateForm = () => {
  ...
  if (!formData.value.teamName.trim()) errors.value.teamName = 'Название команды обязательно'
  if (!formData.value.city.trim()) errors.value.city = 'Город обязателен'
  if (!formData.value.captainName.trim()) errors.value.captainName = 'Имя капитана обязательно'
  if (!formData.value.captainPhone.trim()) errors.value.captainPhone = 'Телефон обязателен'
  if (!formData.value.captainEmail.trim()) errors.value.captainEmail = 'Email обязателен'
  if (!formData.value.playersCount) errors.value.playersCount = 'Количество игроков обязательно'
  if (!formData.value.experience) errors.value.experience = 'Уровень опыта обязателен'
  ...
  if (formData.value.captainEmail && !emailRegex.test(formData.value.captainEmail)) {
    errors.value.captainEmail = 'Некорректный email'
  }

  // Phone validation
  const phoneRegex = /^[\+]?[0-9\s\-\(\)]{10,}$/
  if (formData.value.captainPhone && !phoneRegex.test(formData.value.captainPhone)) {
